...
class NuScenesMultiView_Map_Dataset_CarVelocity(NuScenesMultiViewDataset):
    ...
    def get_data_info(self, index):
        ...
        if 'ann_info' in data_info:
            ...
            car_velocity = ann_info['gt_car_velocity']
            data_info['ann_info']['gt_car_velocity'] = car_velocity
            # print(sample_token, ann_info['sample_token'])
            assert sample_token == ann_info['sample_token']
    ...
    def evaluate(self, results, vis_mode=False, *args, **kwargs):
        ...
        eval_car_velocity = 'car_velocity' in results[0]
